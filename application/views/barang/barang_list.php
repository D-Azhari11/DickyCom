<div class="row" style="margin-bottom: 10px">
        ...
        <th>Action</th>
            ...
            <td style="text-align:center" width="200px">
                ...
                <a href="barang/update/<?php echo $barang->id_barang ?>" class="btn btn-info btn-sm">update</a>
				<a href="barang/delete/<?php echo $barang->id_barang ?>" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm('Are You Sure ?')">hapus</a>
            </td>
        </tr>
                <?php
            }
