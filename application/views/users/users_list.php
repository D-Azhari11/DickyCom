<div class="row" style="margin-bottom: 10px">
        ...
        <th>Action</th>
            ...
            <td style="text-align:center" width="200px">
                <a href="users/update/<?php echo $users->id_user ?>" class="btn btn-info btn-sm">update</a>
				<a href="users/delete/<?php echo $users->id_user ?>" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm('Are You Sure ?')">hapus</a>
            </td>
        </tr>
                <?php
            }
